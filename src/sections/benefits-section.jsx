        ...
        <div className="mt-10 grid w-full grid-cols-1 gap-5 md:grid-cols-3">
          {steps.map((step, index) => (
            <BlurFade key={step.label} delay={0.15 + index * 0.12}>
              <article className="group flex h-[513px] flex-col justify-between rounded-[30px] bg-[#e4f3e3] px-5 pb-7 pt-2.5 text-white">
                ...
                <div className="space-y-4">
                  <span className="inline-flex items-center gap-2 rounded-[11px] border border-[#6fe965] bg-[#ffffff] px-3 py-1 text-xs font-medium text-[#6fe965] text-[16px]">
                    <span className="size-1.5 rounded-full bg-accent" />
                    {step.label}
                  </span>

                  <h2 className="text-lg font-semibold md:text-xl text-[#000300] text-[24px]">
                    {step.title}
                  </h2>

                  <p className="text-sm leading-6 text-[#000300] opacity-80 text-[16px]">
                    {step.description}
                  </p>
                </div>
              </article>
