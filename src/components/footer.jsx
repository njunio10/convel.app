...
export default function Footer() {
  return (
    <footer className="px-4 pt-30 text-brand-dark/70 md:px-16 lg:px-24">
      <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:gap-16">
        <div className="flex-1">
          ...
          <p className="mt-6 max-w-sm text-sm/6">
            ...
            customizable components built with Tailwind CSS and production-ready
            templates.
          </p>
          <div className="mt-2 flex items-center gap-3 text-brand-dark/60">
            <a
        ...
        <div className="flex flex-col items-start justify-around gap-8 md:flex-1 md:flex-row md:gap-20">
          <div className="flex flex-col">
            <h2 className="mb-5 font-semibold text-brand-dark">Company</h2>
            <a
              href="/"
              className="py-1.5 transition duration-200 hover:text-brand-dark"
              aria-label="Home"
              title="Home"
            >
              Home
          ...
          <div>
            <h2 className="mb-5 font-semibold text-brand-dark">
            ...
            <div className="max-w-xs space-y-6 text-sm">
              ...
              <form className="flex items-center justify-center gap-2 rounded-md bg-gray-100 p-1.5">
                <input
                  ...
                  required
                />
                <button className="rounded bg-brand-dark px-4 py-2 text-white transition hover:opacity-90">
                  Subscribe
                </button>
              </form>
            </div>
      ...
      <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-brand-dark/15 py-4 md:flex-row">
        <p className="text-center">
          Copyright 2025 ©{" "}
          <a href="https://prebuiltui.com?utm_source=slidex">PrebuiltUI</a> All
          Right Reserved.
        </p>
        <div className="flex items-center gap-6">
          <a
            href="/privacy-policy"
            className="transition duration-200 hover:text-brand-dark"
